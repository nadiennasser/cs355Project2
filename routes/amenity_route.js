...
var amenityDal = require('../model/amenity_dal');
//var genreDal = require('../model/genre_dal');

router.get('/all', function(req, res) {
    amenityDal.GetAll(function (err, result) {
            if (err) throw err;
            res.render('displayAllStoreAmen.ejs', {rs: result});
        }
    );
});
...
router.get('/', function (req, res) {
    amenityDal.GetByID(req.query.store_ID, function (err, result) {
            if (err) throw err;

            res.render('displayStoreAmenInfo.ejs', {rs: result, store_ID: req.query.store_ID});
        }
    );
});
